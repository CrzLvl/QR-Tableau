...
module.exports = {
  enable: function(instance) {
    ...
    if (!styleEl) {
      ...
      style.textContent = '.svg-pan-zoom-control { cursor: pointer; fill: #C3262F; fill-opacity: 0.333; } .svg-pan-zoom-control:hover { fill-opacity: 0.8; } .svg-pan-zoom-control-background { fill: white; fill-opacity: 0.5; } .svg-pan-zoom-control-background { fill-opacity: 0.8; }'
    ...
    // Control elements
    //zoomGroup.appendChild(this._createZoomIn(instance)) #NR
    zoomGroup.appendChild(this._createZoomReset(instance))
    //zoomGroup.appendChild(this._createZoomOut(instance)) #NR
...
, _createZoomReset: function(instance){
    ...
    resetPanZoomControl.setAttribute('transform', 'translate(5 70) scale(0.4)'); //#NR (Original value translate(5 35))
